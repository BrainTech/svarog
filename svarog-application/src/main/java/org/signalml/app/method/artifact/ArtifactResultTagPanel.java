 ...
 */
public class ArtifactResultTagPanel extends JPanel {
	...
	public ArtifactResultTagPanel(MessageSourceAccessor messageSource, ViewerFileChooser fileChooser) {
		super();
	...
	private void initialize() {
		...
		CompoundBorder border = new CompoundBorder(
			new TitledBorder( messageSource.getMessage("artifactMethod.dialog.result.choosePrimaryTagTitle") ),
		...
		JLabel tagFileLabel = new JLabel(messageSource.getMessage("artifactMethod.dialog.result.primaryTagFile"));
	...
	public void fillPanelFromModel(ArtifactResultTargetDescriptor descriptor) {
	...
	public void fillModelFromPanel(ArtifactResultTargetDescriptor descriptor) {
	...
	public void validatePanel( Errors errors ) {
		...
		if( tagFile == null ) {
			errors.rejectValue("primaryTagFile", "error.artifact.result.badTagFile");
		} else {
			File parent = tagFile.getParentFile();
			if( parent == null || !parent.exists() || !parent.canWrite() ) {
				errors.rejectValue("primaryTagFile", "error.artifact.result.tagFileNotWritable");
			}
		}
	...
	protected class ChooseTagFileAction extends AbstractAction {
		...
		public ChooseTagFileAction() {
			super(messageSource.getMessage("artifactMethod.dialog.result.choosePrimaryTagFile"));
			putValue(AbstractAction.SMALL_ICON, IconUtils.loadClassPathIcon("org/signalml/app/icon/find.png") );
			putValue(AbstractAction.SHORT_DESCRIPTION,messageSource.getMessage("artifactMethod.dialog.result.choosePrimaryTagFileToolTip"));
		}
		
		public void actionPerformed(ActionEvent ev) {			
			
			File file = fileChooser.chooseSaveTag(ArtifactResultTagPanel.this.getTopLevelAncestor());
			if( file == null ) {
				return;
			}
