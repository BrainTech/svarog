/* RemoveAllAbortedTasksAction.java created 2008-02-07
 *
 */
 ...
 */
public class RemoveAllAbortedTasksAction extends AbstractSignalMLAction {

	private static final long serialVersionUID = 1L;

	protected static final Logger logger = Logger.getLogger(RemoveAllAbortedTasksAction.class);
	...
	public RemoveAllAbortedTasksAction() {
		...
		setToolTip(_("Remove all aborted tasks"));
	}

	@Override
	public void actionPerformed(ActionEvent ev) {

		int ans = OptionPane.showRemoveAllAbortedTasks(optionPaneParent);
