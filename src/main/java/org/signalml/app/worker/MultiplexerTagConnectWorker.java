...
public class MultiplexerTagConnectWorker extends SwingWorker< WorkerResult, Integer> {
	...
	public MultiplexerTagConnectWorker( ViewerElementManager elementManager,
    ...
    protected void process( List<Integer> states) {
        for (Integer i : states) {
            ...
            connectingState = i;
            firePropertyChange( "tagConnectingState", oldConnectingState, connectingState);
        }
    }
