...
/**
 * This is an abstract class representic an object that - when given a {@link MonitorSignalDocument}
...
public abstract class GenericAmplifierDiagnosis {
        ...
        /**
         * An abstract method which - based on the information from the
         * {@link MonitorSignalDocument} object - returns an information on
         * each channel
         *
