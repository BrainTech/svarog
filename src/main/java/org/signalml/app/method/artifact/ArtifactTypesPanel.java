 ...
 */
public class ArtifactTypesPanel extends JPanel {
	...
	public ArtifactTypesPanel(MessageSourceAccessor messageSource) {
		super();
	...
	private void initialize() {
		...
		CompoundBorder border = new CompoundBorder(
			new TitledBorder( messageSource.getMessage("artifactMethod.dialog.chooseArtifactTypes") ),
	...
	public void fillPanelFromParameters(ArtifactParameters parameters) {
	...
	public void fillParametersFromPanel(ArtifactParameters parameters) {
	...
	public void setLockOnType( ArtifactType type, boolean locked ) {
