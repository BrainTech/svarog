...
public class ButterworthIIRDesignerTest {
	...
	public void testDesignAnalogFilter() throws BadFilterParametersException {
		...
		double[] pya = new double[] {1.00000000e+00, 1.79338716e+01, 1.60811875e+02,
	...
	public void testDesignDigitalFilter() throws BadFilterParametersException {
		...
		//highpass
		pyb = new double[] {0.0030623, -0.02449839, 0.08574436,
		                    -0.17148872, 0.2143609, -0.17148872,
		                    0.08574436, -0.02449839, 0.0030623
		                   };
		pya = new double[] {1.00000000e+00, 1.28289711e+00, 1.72596336e+00,
		...
		//bandpass
		pyb = new double[] {4.06633016e-04, 0.00000000e+00, -2.43979810e-03,
		...
		pya = new double[] {1.00000000e+00, 2.99246806e-16, 3.49439866e+00,
		...
		//bandstop
		pyb = new double[] {7.65853414e-02, 5.23150264e-07, 4.59512048e-01,
		...
		pya = new double[] {1.00000000e+00, 4.16730153e-06, 1.32074661e+00,
		...
		assertEquals(new FilterCoefficients(pyb, pya), coeffs, 1e-6);
