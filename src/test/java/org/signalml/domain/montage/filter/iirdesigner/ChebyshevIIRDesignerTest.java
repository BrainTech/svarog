...
public class ChebyshevIIRDesignerTest {
	...
	/**
	 * Test method for {@link ChebyshevIIRDesigner#calculateFilterOrder(org.signalml.domain.montage.filter.iirdesigner.FilterType, double[], double[], double, double, boolean) }.
	 */
	@Test
