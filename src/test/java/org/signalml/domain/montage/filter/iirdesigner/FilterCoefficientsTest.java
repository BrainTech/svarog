...
public class FilterCoefficientsTest {
	...
	public void testTransformLowpassToLowpass() throws BadFilterParametersException {
		...
		double[] pyb = new double[] {47573.76605485};
		double[] pya = new double[] {1.00000000e+00, 8.61750040e+00, 3.18380657e+02,
		                             1.85266276e+03, 2.06532946e+04, 4.75737661e+04
		                            };
		coeffs.transformLowpassToLowpass(15.0);
		assertEquals(new FilterCoefficients(pyb, pya), coeffs, 1e-3);
	...
	public void testTransformLowpassToHighpass() throws BadFilterParametersException {
		...
		double[] pyb = new double[] {1, 0, 0, 0, 0, 0};
		double[] pya = new double[] {1.00000000e+00, 1.95359404e+01, 7.88594723e+01,
	...
	public void testTransformLowpassToBandpass() throws BadFilterParametersException {
		...
		double[] pyb = new double[] {2.00475456, 0, 0, 0, 0, 0};
		double[] pya = new double[] { 1.00000000e+00, 1.14900006e+00, 5.06601006e+01,
	...
	public void testTransformLowpassToBandstop() throws BadFilterParametersException {
		...
		double[] pyb = new double[] {1.00000000e+00, 0.00000000e+00, 4.50000000e+01,
		                             0.00000000e+00, 8.10000000e+02, 0.00000000e+00,
		                             7.29000000e+03, 0.00000000e+00, 3.28050000e+04,
		                             0.00000000e+00, 5.90490000e+04
		                            };
		double[] pya = new double[] {1.00000000e+00, 1.30239603e+01, 8.00486546e+01,
	...
	public void testTransformLowpassToBandstopAndBilinearTransform() throws BadFilterParametersException {
		...
		double[] pyb = new double[] {1.0000000, 0.0000000, 15.9999925};
		double[] pya = new double[] {1.0000000, 7.7980768, 15.9999925};
		assertEquals(new FilterCoefficients(pyb, pya), coeffs, 1e-5);

		coeffs.bilinearTransform(2.0);
		pyb = new double[] {5.06390694e-01, -2.37380515e-07, 5.06390694e-01};
		pya = new double[] {1.00000000e+00, -2.37380515e-07, 1.27813882e-02};
		assertEquals(new FilterCoefficients(pyb, pya), coeffs, 1e-5);
	...
	public void testBilinearTransform() throws BadFilterParametersException {
		...
		pyb = new double[] {5.06390694e-01, -2.37370693e-07, 5.06390694e-01};
		pya = new double[] {1.00000000e+00, -2.37370693e-07, 1.27813880e-02};
