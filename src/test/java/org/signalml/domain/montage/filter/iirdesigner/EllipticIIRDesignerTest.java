...
public class EllipticIIRDesignerTest {
	...
	/**
	 * Test method for {@link EllipticIIRDesigner#designDigitalFilter(org.signalml.domain.montage.filter.iirdesigner.FilterType, double[], double[], double, double) }.
	 */
	@Test
	public void testDesignDigitalFilter() throws BadFilterParametersException {
		...
		//lowpass test
		pyb = new double[] {0.00881574, -0.00485172, -0.00485172, 0.00881574};
		pya = new double[] {1.0, -2.74146002, 2.58002871, -0.83064064};

		coeffs = iirdesigner.designFilter(FilterType.LOWPASS, new double[] {0.1}, new double[] {0.2}, 3.0, 40.0, false);
		assertEquals(new FilterCoefficients(pyb, pya), coeffs, 1e-5);

		//highpass
		pyb = new double[] {0.04105714, -0.05209928, 0.05209928, -0.04105714};
		pya = new double[] {1.0, 1.85768178, 1.61734402, 0.57334941};
		...
		//bandpass test
		pyb = new double[] {0.02114251, 0.01792455, -0.00243741,
		                    0.0, 0.00243741, -0.01792455, -0.02114251
		                   };
		pya = new double[] {1.0, 1.73921561, 3.38814582,
		...
		//bandstop test
		pyb = new double[] {0.0987149, 0.16661581, 0.31652632,
		                    0.30320545, 0.31652632, 0.16661581,
		                    0.0987149
		                   };
		pya = new double[] {1.0, 0.68543316, -0.66268689,
	...
	/**
	 * Test method for {@link EllipticIIRDesigner#calculateBandstopObjectiveFunctionValue(double, org.signalml.domain.montage.filter.iirdesigner.AbstractIIRDesigner.BandstopObjectiveFunction) }.
	 */
	@Test
	...
	/**
	 * Test method for {@link EllipticIIRDesigner#calculateNaturalFrequency(org.signalml.domain.montage.filter.iirdesigner.FilterType, int, double, double, double, double, boolean) }.
	 */
	@Test
	...
	/**
	 * Test method for {@link EllipticIIRDesigner#calculateFilterOrder(org.signalml.domain.montage.filter.iirdesigner.FilterType, double[], double[], double, double, boolean) }.
	 */
	@Test
