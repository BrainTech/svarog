...
public class NewStagerSleepComparisonTable extends JTable {
	...
	@Override
	public NewStagerSleepComparisonTableModel getModel() {
		return (NewStagerSleepComparisonTableModel) super.getModel();
	}
	...
	protected void configureEnclosingScrollPane() {
		...
		if (!(model instanceof NewStagerSleepComparisonTableModel)) {
			return;
		}
		NewStagerSleepComparisonTableModel tableModel = (NewStagerSleepComparisonTableModel) model;
	...
	/*
	 * @Override public JPopupMenu getComponentPopupMenu() { if( popupMenu ==
	 * null ) { popupMenu = new JPopupMenu(); popupMenu.add( new
	...
	private class HeaderTable extends JTable {
		...
		public JPopupMenu getComponentPopupMenu() {
			return NewStagerSleepComparisonTable.this.getComponentPopupMenu();
		}
